...
## Netflix for Trailers
   ...
   - [] User can login
   - [] Use can use it as a guest
   - [] User can view the trailers in the following navigation pages
       - Trending Page (Also Home Page) shows the latest movies in theater
           ...
           - [] User can add the movie / shows to their watch list to watch when it comes to theater or vod (Only for Members)
       - Upcoming Page shows the upcoming trailers
        ...
        - Page to search for a movie / tv shows
            - [] User can filter by name, genre, year, actor and director
        - Account Page
            - [] User can change and view account details
            - [] Settings toggle for notificaiton and age restriction
